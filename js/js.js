function start() {
    ...
    function moveJogador() {
        if (jogo.pressionou[TECLA.W]) {
            ...
            //faz com que o elicoptero não ultrapasse o topo da pagina
            if (topo<=0) {
                $("#jogador").css("top",topo + 10);
            }
        }
    ...
    //  mover o inimigo 1, helicóptero amarelo
    ...
    //mover o amigo, o que vai ser resgatado
    function moveAmigo() {
    ...
    //verifica se ouve a colisão dos itens do jogo
    function colisao() {
    ...
    //energia (vida) do jogador, helicóptero cinza
    function energia() {
        if (energiaAtual == 3) {
